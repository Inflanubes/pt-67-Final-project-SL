...
Revision ID: 3d5ba786121c
Revises: 
Create Date: 2024-11-15 08:56:42.303519
...
def upgrade():
    ...
    sa.Column('bicycle', sa.Enum('santaCruz', 'kona', 'canyon', 'custom', name='bikes'), nullable=False),
